            ...
            <Grid item xs={12} md={8} lg={8}>
              <Grid container spacing={2} className="icon_box_left">
                <Box sx={{ marginRight: "15px" }}>
                  <Box className="box-mobile">
                    <GroupIcon
                      className="icon-co custom-icon-size"
            ...
            <Grid item xs={12} md={4} lg={4}>
              <Grid container spacing={2} className="icon_box_home">
                <Link className="d-flex icon-box">
                  <LinkedInIcon
                    className="linkedIn icon-site"
                    sx={{ color: "rgb(0, 119, 181)" }}
                  />
                </Link>
                <Link className="d-flex icon-box">
                  <TwitterIcon
                    className="Twitter icon-site"
                    sx={{ color: "rgb(0, 119, 181)" }}
                  />
                </Link>
                <Link className="d-flex icon-box">
                  <YouTubeIcon
                    className="YouTub icon-site"
        ...
        <Container sx={{ marginTop: "60px" }}>
          <Grid container spacing={3} sx={{ justifyContent: "center" }}>
            <Grid item className="mt-rev" sx={6}>
              <button className="button-6_1custom">
                <AddIcon />
                Tools Added Today
              </button>
            </Grid>
            <Grid item className="mt-rev" sx={6}>
              <button className="button-6">
                <PostAddIcon /> News Added Today
              </button>
            </Grid>
          </Grid>
          <Grid>
            <Typography
              className="fontSize-35_mt_10 revert "
              variant="button"
              display="block"
              sx={{
                fontSize: "50px",
                          ...
                          {tool?.price?.map((data, idx) => (
                            <Grid item className="m-2">
                              <Typography className="tagCard1">
                                ...
                                {data === "Free" && (
                                  <TaskAltIcon className="cardTagIcon" />
                                )}
                                {data === "Paid" && (
                                  <MonetizationOnIcon className="cardTagIcon" />
                                )}
                                {data === "Contact for Pricing" && (
                                  <MonetizationOnIcon className="cardTagIcon" />
                                )}
                                {data === "Deals" && (
                                  <SellIcon className="cardTagIcon" />
                                )}
                                {data}
                              </Typography>
                            </Grid>
